...
describe('CurrencyServiceService', () => {
  ...
  it('#getAllCurrencies should return correct size', inject([CurrencyServiceService], (service: CurrencyServiceService) => {
    service.getAllCurrencies().subscribe(result => expect(result.length).toBe(6));
  }));
  ...
  it('#getFiltredAndPaginatedCurrencies should return less than 10 elements', inject([CurrencyServiceService], (service: CurrencyServiceService) => {
    service.getFiltredAndPaginatedCurrencies().subscribe(result=> expect(result.length).toBeLessThan(10));
  }));
  ...
  it('#getFiltredAndPaginatedCurrencies should return specific element', inject([CurrencyServiceService], (service: CurrencyServiceService) => {
    service.getFiltredAndPaginatedCurrencies(10,1,'ID','USD').subscribe(result=> expect(result.length).toBe(1));
    service.getFiltredAndPaginatedCurrencies(1, 2, 'TYPE','national').subscribe(result => expect(result.length).toBe(1));
    service.getFiltredAndPaginatedCurrencies(4, 1, 'TYPE','national').subscribe(result => expect(result.length).toBe(4));
    service.getFiltredAndPaginatedCurrencies(4, 2, 'TYPE','national').subscribe(result => expect(result.length).toBe(2));
    service.getFiltredAndPaginatedCurrencies(4, 3, 'TYPE','national').subscribe(result => expect(result.length).toBeFalsy());
    service.getFiltredAndPaginatedCurrencies(4, 3, 'TYPE','xyz').subscribe(result => expect(result.length).toBeFalsy());
    service.getFiltredAndPaginatedCurrencies(4, 2, '','').subscribe(result => expect(result.length).toBe(2));
    service.getFiltredAndPaginatedCurrencies(4, 1, '','').subscribe(result => expect(result.length).toBe(4));
    service.getFiltredAndPaginatedCurrencies(-1, 0, '','').subscribe(result => expect(result.length).toBe(0));
